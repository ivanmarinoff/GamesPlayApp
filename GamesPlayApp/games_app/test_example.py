...
def test_home_page_to_be_visible(page: Page) -> None:
    ...
    expect(page).to_have_url("https://gamesplay-app.onrender.com/")
...
def test_dashboard_to_be_visible(page: Page) -> None:
    page.goto("https://gamesplay-app.onrender.com/profile/dashboard/")
    expect(page).to_have_url("https://gamesplay-app.onrender.com/profile/dashboard/")


def test_create_user_profile(page: Page) -> None:
    page.goto("https://gamesplay-app.onrender.com/profile/create/")
    expect(page).to_have_url("https://gamesplay-app.onrender.com/profile/create/")
...
def test_profile_to_be_visible(page: Page) -> None:
    page.goto("https://gamesplay-app.onrender.com/profile/details/")
    expect(page).to_have_url("https://gamesplay-app.onrender.com/profile/details/")
...
def test_edit_user_profile(page: Page) -> None:
    page.goto("https://gamesplay-app.onrender.com/profile/edit/")
    expect(page).to_have_url("https://gamesplay-app.onrender.com/profile/edit/")
...
def test_create_game_to_be_visible(page: Page) -> None:
    page.goto("https://gamesplay-app.onrender.com/game/create/")
    expect(page).to_have_url("https://gamesplay-app.onrender.com/game/create/")
